...
public class Fireball extends Sprite {
    ...
    public Fireball(World world, PlayScreen screen, float x,float y ) {

        enemystanding= new Texture("fire-ball.png");
        ...
        for (int i = 0; i < 3; i++)
            frames.add(new TextureRegion(enemystanding, i*57/3, 0, 57/3, 16));
...
float pos= b2body.getPosition().x;
            ...
            if (pos < 0 || destroy)
            {
               ...
               // b2body.setActive(false);
                ...
                setBounds(0, 0, 57 / 3, 16);
                setPosition(b2body.getPosition().x, b2body.getPosition().y-5);
